...
export const ICONS: IconDef[] = [
  ...
  { key: 'copy', label: '复制', path: '<rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>' },
  { key: 'check', label: '完成', path: '<path d="M20 6 9 17l-5-5"/>' },
